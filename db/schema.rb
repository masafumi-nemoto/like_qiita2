...
ActiveRecord::Schema.define(version: 2021_01_17_155445) do
  ...
  create_table "replication_asynchronous_connection_failover", primary_key: ["Channel_name", "Host", "Port", "Network_namespace"], options: "/*!50100 TABLESPACE `mysql` */ ENGINE=InnoDB DEFAULT CHARSET=utf8 STATS_PERSISTENT=0 ROW_FORMAT=DYNAMIC", comment: "The source configuration details", force: :cascade do |t|
